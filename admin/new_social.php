...
global $conn;
$sql1 = "INSERT INTO social (stitle, icons, links, status) VALUES(:stitle, :icons, :links, :status)";
                       ...
                       <div class="col-lg-8"> <!-- col-lg-8 -->
                            <div class="card"> <!-- card -->
                                 ...
                                 <div class="card-header">
                                    <i class="fa fa-heart-o"></i> New Social Media
                                </div>
                               <!-- /card-header -->
                               <!-- card-block -->
                                <div class="card-block">
                                    <form action="new_social.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="form-group row">
                                            <label class="col-md-1 form-control-label" for="stitle">Social</label>
                                            <div class="col-md-9">
                                                <input type="text" id="stitle" name="stitle" class="form-control" placeholder="Text">
                                            </div>
                                        </div> 
                                        <div class="form-group row">
                                            <label class="col-md-1 form-control-label" for="icons">Icons</label>
                                            <div class="col-md-9">
                                                <input type="text" id="icons" name="icons" class="form-control" placeholder="Text">
                                            </div>
                                        </div> 
                                        <div class="form-group row">
                                            <label class="col-md-1 form-control-label" for="links">Links</label>
                                            <div class="col-md-9">
                                                <input type="text" id="links" name="links" class="form-control" placeholder="Text">
                                            </div>
                                        </div> 
                                        <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                      <div class="col-md-9">
                                    <button type="submit" id="submit_social" name="submit_social" class="btn btn-sm btn-primary"><i class="fa fa-dot-circle-o"></i> Submit</button>
